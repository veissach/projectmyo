...
class EmgData:#envelope functions  
    ...
    def __init__(self, subject_num, channels, lRange, uRange, ):
    ...
    def calc_envelope(self, signal, freq=5., smooth=51):
    ...
    def data_prep(self):
        _data1, _data2 = self.loader(self.lRange, self.uRange)
        
        mav1 = self.MAV(_data1)
        mav2 = self.MAV(_data2)
    ...
    #sum_ = numpy.array(sum_env(mav1, mav2)[20000:6000])
